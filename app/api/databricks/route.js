...
export async function GET() {
  try {
    ...
    const prompt = `以下はDatabricksに関するWeb検索の生データです。
この情報をもとに、データエンジニアが知っておくべきDatabricks関連情報を8件抽出してください。
    ...
    "links": [
      {
        "titleEn": "リンクタイトル（英語）",
        "titleJa": "リンクタイトル（日本語）",
        "source": "Databricks Blog または Qiita など",
        "url": "https://..."
      }
    ]
  }
...
各フィールドは必ず簡潔に。summaryは1文、descは2文以内に収めること。`;
