...
export async function GET() {
  try {
    ...
    const queries = [
      `AI LLM latest news Claude GPT Gemini ${currentYear}`,
      `AI 最新情報 LLM Claude ${currentYear} 日本`
    ];
    ...
    const prompt = `以下はAIに関するWeb検索の生データです。
エンジニアが知っておくべきAI・LLMの最新情報を8件抽出してください。
...
[
  {
    "titleEn": "英語タイトル",
    "titleJa": "日本語タイトル",
    "type": "Model または Research または Tool または Qiita",
